...
public class PawPrints extends GraphicsProgram {
	...
	public void run() {
//sends offset coordinates to each method to draw two paw prints
		drawPawprint(20, 20);
		drawPawprint(180, 70);
	}
...
//draw each toe using the offset and height and width constants
...
//draw heel using the offset and height and width constants
